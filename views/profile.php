...
<head>
    ...
    <title>Student Profile - Brinware University</title>
...
<body>
    ...
    <div class="profile-card">
        <div class="text-center">
            <img src="profile.jpg" alt="Student Photo" class="profile-photo">
        ...
        <div class="details-section">
            ...
            <p>Email: student.email@example.com</p>
            <p>Phone: (123) 456-7890</p>
            <hr>
            <h5>Academic Details</h5>
            <p>Program: [Degree Program]</p>
            <p>GPA: [Current GPA]</p>
            <p>Enrollment Year: [Year]</p>
            <hr>
            <h5>Address</h5>
